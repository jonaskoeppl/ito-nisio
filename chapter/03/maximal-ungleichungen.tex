...
\begin{proof*}
   ...
   Daraus folgt schließlich
    ...
    \end{align*}
    unter der Verwendung der Symmetrie von $X_1,...,X_N$, und folgert daraus letztendlich 
    \begin{align*}
...
\begin{corollary}
    Sei $(X_n)_{n \in \N}$ eine Folge unabhängiger und symmetrischer E-wertiger Zufallsvariablen. Falls $S_n \schwach S$ für $S \in \mathcal{L}_0(E)$, dann gilt für $\lambda$-fast-alle $t \in \R$
    $$
