...
\begin{proof*}
    ...
    $$
        \mathcal{R}:=\{A \in \mathcal{B}(X):  \mu(A) = \sup\{\mu(C): C \subseteq A, \ C \text{ abgeschlossen}\} =\inf\{\mu(O): A \subseteq O, \ O \text{ offen}\} \}.
    $$
    ...
    $$ 
    Die Menge $C:= \cup_{n=1}^kC_n$ ist als endliche Vereinigung abgeschlossener Mengen selbst abgeschlossen und offensichtlich in $\cup_{n=1}^{\infty}A_n$ enthalten. Ferner gilt 
    \begin{align}
    ...
    \end{align}
    Da $\varepsilon$ beliebig gewählt war folgt nun aus $(1.1)$ und $(1.2)$, dass $\cup_{n=1}^{\infty}A_n \in \mathcal{R}$. Also ist $\mathcal{R}$ eine $\sigma$-Algebra. 
    Wir zeigen nun, dass $\mathcal{R}$ alle abgeschlossenen Mengen enthält. Sei also $\emptyset \neq A \subseteq X$ abgeschlossen. Die Bedingung 
    $$
    ...
    $$
        O_n := \{x \in X: \inf_{y \in  A}d(x,y) < \frac{1}{n}\}.
    $$
    Dann ist $O_n$ für jedes $n \in \N$ offen und es gilt $O_1 \supseteq O_2 \supseteq ...$, sowie $\cup_{n=1}^{\infty}O_n = A$, da $A$ abgeschlossen ist. 
    ...
    $$
    Da die abgeschlossenen Mengen $\mathcal{B}(X)$ erzeugen folgt also $\mathcal{R} = \mathcal{B}(X)$ und folglich ist $\mu$ regulär. \qed
\end{proof*}
\begin{mydef}
...
\input{chapter/01/portmanteau-theorem}